...
contract Optimizor {
    ...
    address public fallbackConvexCurve;
    address public fallbackConvexFrax;
    ...
    constructor(ConvexMapper _convexMapper) {
        convexMapper = _convexMapper;
        fallbacks.push(LOCKER_STAKEDAO);
        fallbacks.push(fallbackConvexCurve);
        fallbacks.push(fallbackConvexFrax);
    }
