...
contract LockerManager {
    ...
    function increaseAmount(uint256 value) external virtual {}

    /// @notice Extend unlock time on the locker
    /// @param unlock_time New epoch time for unlocking
    function increaseUnlockTime(uint256 unlock_time) external virtual {}
    ...
    function transferLockerGovernance(address _governance) external virtual {}
    ...
    function transferLockerStrategy(address _strategy) external virtual {}
}
